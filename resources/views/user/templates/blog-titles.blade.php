					...
					<div class="row">
						<div class="template-view">
							<div class="template-icon mb-2 d-flex">
								...
								<div>
									<h6 class="mt-1 ml-3 fs-16 number-font">{{ __('Blog Titles') }} @if($template->professional) <span class="fs-8 btn btn-yellow ml-2"><i class="fa-sharp fa-solid fa-crown mr-2"></i>{{ __('Pro') }}</span> @endif</h6>
								</div>
								<div>
					...
					<div class="row">
						...
						<div class="col-sm-12">								
							<div class="input-box">								
								...
								<div class="form-group">							    
									<textarea type="text" rows=5 class="form-control @error("description") is-danger @enderror" id="description" name="description" placeholder="e.g. Describe your blog post" required></textarea>
									@error('description')
