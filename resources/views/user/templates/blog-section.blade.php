			...
			<div class="card border-0" id="template-input">
				<div class="card-body p-5 pb-0">
					...
					<div class="row">
						<div class="template-view">
							<div class="template-icon mb-2 d-flex">
								...
								<div>
									<h6 class="mt-1 ml-3 fs-16 number-font">{{ __('Blog Section') }} @if($template->professional) <span class="fs-8 btn btn-yellow ml-2"><i class="fa-sharp fa-solid fa-crown mr-2"></i>{{ __('Pro') }}</span> @endif</h6>
								</div>
								<div>
					...
					<div class="row">
						...
						<div class="col-sm-12">								
							<div class="input-box">								
								<h6 class="fs-11 mb-2 font-weight-semibold">{{ __('Title of your blog article') }}  <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
								<div class="form-group">							    
									<textarea type="text" rows=3 class="form-control @error('title') is-danger @enderror" id="title" name="title" placeholder="e.g. 5 best places to visit in Spain" required></textarea>
									@error('title')
						...
						<div class="col-sm-12">								
							<div class="input-box">								
								<h6 class="fs-11 mb-2 font-weight-semibold">{{ __('Subheadings') }}  <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
								<div class="form-group">							    
									<textarea type="text" rows=3 class="form-control @error("subheadings") is-danger @enderror" id="subheadings" name="subheadings" placeholder="e.g. Barcelona, San Sebastian, Madrid" required></textarea>
									@error('subheadings')
										<p class="text-danger">{{ $errors->first('subheadings') }}</p>
									@enderror
								</div> 
							</div> 
						</div>
