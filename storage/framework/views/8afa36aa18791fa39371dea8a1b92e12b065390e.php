							...
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									...
									<select id="user-role" name="role" data-placeholder="<?php echo e(__('Select User Role')); ?>" required>	
										...
										<option value="subscriber"><?php echo e(__('Subscriber')); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\xampp\htdocs\openaidavinci\resources\views/admin/users/list/create.blade.php ENDPATH**/ ?>