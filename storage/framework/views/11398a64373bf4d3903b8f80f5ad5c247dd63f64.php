				...
				<div class="card-body text-center">
					...
					<div class="col-lg-6 col-md-6 col-sm-12">
						<?php if(is_null(auth()->user()->plan_id)): ?>
							...
							<a href="<?php echo e(route('user.plans')); ?>" class="btn btn-primary mt-3"><i class="fa-solid fa-hand-holding-box mr-2"></i><?php echo e(__('Upgrade Now')); ?></a>
						<?php else: ?>
							<div class="d-flex w-100">
								<div class="flex w-100">
							...
							<?php $__currentLoopData = $custom_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<div class="col-lg-3 col-md-6 col-sm-12" id="<?php echo e($template->template_code); ?>">
									<div class="template">
										...
										<div class="card <?php if($template->professional): ?> professional <?php elseif($template->favorite): ?> favorite <?php else: ?> border-0 <?php endif; ?>" onclick="window.location.href='<?php echo e(url('user/templates')); ?>/<?php echo e($template->slug); ?>/<?php echo e($template->template_code); ?>'">
											<div class="card-body pt-5">
												<div class="template-icon mb-4">
													<?php echo $template->icon; ?>													
												</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\xampp\htdocs\openaidavinci\resources\views/user/dashboard/index.blade.php ENDPATH**/ ?>